...
if (EVENT == 4000) then
	...
	if (Class == 4 or Class == 11 or Class == 12) then
		...
		if (SkillPoint > 59) then 
			SelectMsg(UID, 3, -1, 4144, NPC, 4143, 4007, 4144, 4010, 4002, 4013, 4003, 4016, 47, 4002);
		elseif (SkillPoint > 49) then 
			SelectMsg(UID, 3, -1, 4144, NPC, 4143, 4007, 4144, 4010, 4002, 4013, 47, 4002);
		elseif (SkillPoint > 39) then 
			SelectMsg(UID, 3, -1, 4144, NPC, 4143, 4007, 4144, 4010, 47, 4002);
		elseif (SkillPoint > 29) then 
			SelectMsg(UID, 3, -1, 4144, NPC, 4143, 4007, 47, 4002);
		else  
...
-- [AUTO-GEN] quest=159 status=255 n_index=4141
if (EVENT == 4004) then
	SaveEvent(UID, 4142);
end
