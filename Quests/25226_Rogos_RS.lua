...
-- [AUTO-GEN] quest=1443 status=255 n_index=4928
if (EVENT == 240) then
	SaveEvent(UID, 4929);
end

-- [AUTO-GEN] quest=1443 status=0 n_index=4929
if (EVENT == 242) then
	SelectMsg(UID, 4, 1443, 0, NPC, 793, 243, 23, -1);
end
...
-- [AUTO-GEN] quest=1443 status=1 n_index=4930
if (EVENT == 245) then
	SelectMsg(UID, 2, 1443, 0, NPC, 10, -1);
end
...
-- [AUTO-GEN] quest=1443 status=1 n_index=4930
if (EVENT == 247) then
	QuestStatusCheck = GetQuestStatus(UID, 1443)
